...
- Bước 1 (BẮT BUỘC): Đọc nội dung 4  file thiết kế tại `02_design_toan_final.md`,`04_design_toan_3d.md`,`05_threejs_engine.md`, `06_geometry_math.md` và `REDESIGN_GUIDE_3D.md`
